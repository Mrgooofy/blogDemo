...
public class JwtUtil {
     ...
     * 密钥
     */
    private static final String SECRET = "a29zZGthZG8yMzIzZWt2ZHMzMjM=";
    ...
    public static String createJWT(Map<String, Object> claims) throws Exception {
        ...
        long ttlMillis = EXPIRATION * 1000;
        String id = JWT_ID;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<String, Object> claims = new HashMap<>();
            claims.put("uid", "23");
            claims.put("nickname", "nickname223");

            String jwt = util.createJWT(claims);
            ...
            System.out.println("nickname " + c.get("nickname"));
